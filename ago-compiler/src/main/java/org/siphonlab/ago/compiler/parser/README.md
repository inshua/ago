...
The ago grammar file is primarily based on https://github.com/antlr/grammars-v4/tree/master/antlr/antlr4/examples/grammars-v4/java/java,
Additionally, parts are taken from the JavaScript grammar at https://github.com/antlr/grammars-v4/blob/master/antlr/antlr4/examples/grammars-v4/javascript/javascript/
However, there have been significant modifications.
